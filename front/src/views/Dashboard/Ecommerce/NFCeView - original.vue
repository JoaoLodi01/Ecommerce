  ...
  <div class="nfce-container">
    ...
    <div class="product-list">
      ...
      <table>
        ...
        <tbody>
          <tr v-for="(product, id) in searchResults" :key="id">
            ...
            <td><button @click="removeProduct(id)">Remover</button></td>
  ...
  methods: {
    async searchProduct() {
      ...
      try {
        ...
        console.log('Resultado das buscas', this.searchResults)
    ...
    calculateTotal(product) {
      this.total += product.quantidade * product.price - product.discount + product.addition;
    },
