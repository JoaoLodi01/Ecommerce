    ...
    <b-sidebar
      ...
      <div class="sidebar-links p-4">
        <ul class="space-y-4">
          ...
          <li>
            <router-link to="/consumers" class="ml-5 text-white hover:text-blue-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li>
            <router-link to="/products" class="ml-5 text-white hover:text-blue-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li>
            <router-link to="/settings" class="ml-5 text-white hover:text-blue-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li class="fixed bottom-0">
              <router-link to="/updates" class="ml-5 text-white hover:text-blue-300 flex items-center mb-10">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
