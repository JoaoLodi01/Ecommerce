        ...
        <ul class="space-y-4">
          ...
          <li class="fixed bottom-auto" disabled title="EM BREVE">
            ...
            <li 
                ...
                v-if="!sidebarActive"
            >
                <svg title="Trocar de empresa" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6  cursor-pointer mb-8">
