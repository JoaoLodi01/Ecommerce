        ...
        <ul class="space-y-4">
          ...
          <li>
            <router-link :to="`/${issuer_first_name}/customers`" class="hover:text-blue-300 flex items-center gap-4">
              ...
              <span v-if="sidebarActive" class="ml-2">Clientes</span>
            </router-link> 
          </li>
          <li>
            <router-link :to="`/${issuer_first_name}/products`" class="hover:text-blue-300 flex items-center gap-4">
              ...
              <span v-if="sidebarActive" class="ml-2">Produtos</span>
            </router-link>
          </li>
          <li class="w-full">
            <a class="hover:text-blue-300 flex items-center w-full cursor-pointer gap-6" @click="toggleFinancial()">
              ...
              <span class="flex items-center">
                  <span v-if="sidebarActive">Financeiro</span>
