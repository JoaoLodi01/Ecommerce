<template>
  <div class="relative bg-gray-200 h-screen">
    ...
    <div
      ...
      class="transition-transform duration-300 bg-gray-800 text-white  text-base h-screen w-64 fixed top-0 left-0 z-40"
      title="Sidebar">
      ...
      <div class="sidebar-links p-4 ml-1 ">
        <ul class="space-y-4">
          ...
          <li>
            <router-link :to="`/${issuer_name}/customers`" class="hover:text-blue-300 flex items-center gap-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li>
            <router-link :to="`/${issuer_name}/products`" class="hover:text-blue-300 flex items-center gap-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li class="w-full">
            <a class="hover:text-blue-300 flex items-center w-full cursor-pointer gap-6" @click="toggleFinancial()">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <li class="w-max">
            ...
            <div v-if="showRegisters" class="ml-12 bg-gray-700 p-4 rounded-lg m-2 space-y-2">
              <p class="flex items-center gap-2">
                <router-link :to="`/${issuer_name}/`" class="flex items-center">
                  Espécies
                </router-link>
              </p>

              <p class="flex items-center gap-2">
                <router-link :to="`/${issuer_name}/sale/pdv`" class="flex items-center">
                  Centro de custo
                </router-link>
              </p>
          ...
          <li disabled title="EM BREVE">
            <router-link :to="`/${issuer_name}/sale/pdv`" class="hover:text-blue-300 flex items-center gap-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
