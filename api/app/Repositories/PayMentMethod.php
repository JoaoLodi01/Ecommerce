...
class PayMentMethod
{
    ...
    {
        Log::info('-- Inicio do registro no caixa, PayMentMethod.php, linha 20 --');
        ...
        {  
            ...
            for ($i=0; $i < count($formsPayment); $i++) // Percore todo o array enviado de valores
            { 
                ...
                if($payment[$i] > 0)
                {
                    foreach ($formsPayment as $form) 
                    {
                        ...
                        Log::info('Tipo de pagamento: ' . $form->tipo_lancamento);
                        $cashRegisters[] = array(
