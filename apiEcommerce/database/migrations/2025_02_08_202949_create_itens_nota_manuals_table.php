...
return new class extends Migration
{
    ...
    {
        Schema::create('itens_nota_manuals', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('nm_id');
            $table->foreign('nm_id')->references('id')->on('nota_manuals')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('itens_nota_manuals');
    }
};
